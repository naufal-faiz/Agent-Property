    ...
    <header style="display: inline;">
        <div class="jumbotron p-2 d-flex gap-4 justify-content-center align-items-center text-coklat"
            ...
            <div class="d-flex justify-content-center align-items-center">
                <img src="img/Logo Aswa Lengkap 4.webp" alt="" width="50">
            </div>
        ...
        <?php if ($username === "Aswa Administrator"): ?>
            <div class="d-flex justify-content-center flex-column align-items-center pt-5">
                ...
                <div class="d-flex gap-3 mt-3">
                    ...
                    <a class="btn btn-login" aria-current="page" id="adminPage" href="adminLeads/adminLeadsPage.php">Lihat
                        halaman iklan</a>
                </div>
            </div>
        <?php endif; ?>
